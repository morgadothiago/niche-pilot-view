        ...
        <main className="container mx-auto px-4 py-8 max-w-4xl">
          ...
          <div className="prose prose-neutral dark:prose-invert max-w-none space-y-6">
            ...
            <section>
              ...
              <p>
                Ao acessar e usar o AgentChat, você concorda em cumprir e estar vinculado a estes Termos de Serviço. 
            ...
            <section>
              ...
              <p>
                O AgentChat é uma plataforma de agentes de inteligência artificial que permite aos usuários criar, 
                configurar e interagir com assistentes virtuais personalizados para diversos nichos de negócio.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Cada plano possui limites específicos de uso, incluindo número de agentes, mensagens mensais e 
                funcionalidades disponíveis. Os limites são aplicados conforme o plano contratado e podem ser 
                consultados na página de preços.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                O serviço e seu conteúdo original, recursos e funcionalidades são de propriedade do AgentChat 
                e estão protegidos por leis de direitos autorais, marcas registradas e outras leis de 
            ...
            <section>
              ...
              <p>
                Os pagamentos são processados de forma segura. Reembolsos podem ser solicitados dentro de 7 dias 
                após a compra, sujeitos à nossa análise. Créditos não utilizados não são reembolsáveis após o 
                período de garantia.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                O AgentChat não será responsável por quaisquer danos indiretos, incidentais, especiais, 
            ...
            <section>
              ...
              <p>
                Se você tiver alguma dúvida sobre estes Termos de Serviço, entre em contato conosco pelo 
                email: suporte@agentchat.com
              </p>
            </section>
          </div>
        </main>
