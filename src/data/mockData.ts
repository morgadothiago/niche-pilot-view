...
export const messages: Message[] = [
  {
    id: "1",
    content:
      "Olá! Preciso de ajuda para criar uma estratégia de lançamento para meu novo produto SaaS.",
    sender: "user",
    timestamp: "10:25",
  },
  {
    id: "2",
    content:
      "Ótimo! Vou te ajudar a criar uma estratégia completa. Primeiro, me conta um pouco sobre seu produto: qual problema ele resolve e quem é seu público-alvo?",
    sender: "agent",
    timestamp: "10:26",
  },
  {
    id: "3",
    content:
      "É uma plataforma de gestão de projetos focada em equipes remotas. O público são startups e PMEs de tecnologia.",
    sender: "user",
    timestamp: "10:28",
  },
  {
